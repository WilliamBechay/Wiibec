    ...
    >
      <defs>
        ...
        <radialGradient
          ...
          fy="50%"
        >
          <stop offset="0%" stopColor="#A89865" />
          <stop offset="20%" stopColor="#A68147" />
          <stop offset="50%" stopColor="#9A6F32" />
          <stop offset="75%" stopColor="#825D2E" />
          <stop offset="100%" stopColor="#7D734C" />
        </radialGradient>
      </defs>
      <text
        x="0"
